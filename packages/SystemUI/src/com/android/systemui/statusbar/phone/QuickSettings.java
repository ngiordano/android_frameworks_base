...
public class QuickSettings {
   ...
   // private static final int BT_TETHER_TILE = 22;
    ...
    private static final int NAVBAR_HIDE_TILE = 23;
        ...
        switch (tile) {
            ...
            case VIBRATE_TILE:
                ...
                quick.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mCarbonTarget.launchAction(mCarbonTarget.ACTION_VIB);
            ...
            case SILENT_TILE:
                ...
                quick.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mCarbonTarget.launchAction(mCarbonTarget.ACTION_SILENT);
            ...
            case TORCH_TILE:
                ...
                quick.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mCarbonTarget.launchAction(mCarbonTarget.ACTION_TORCH);
                    }
                });
                quick.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
